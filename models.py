...
class Property(db.Model):
    ...
    meals = db.relationship('MealOption', backref='property', lazy=True)
    rooms = db.relationship('Room', backref='property', lazy=True)
    faqs = db.relationship('FAQ', backref='property', lazy=True)
    daily_prices = db.relationship('DailyPrice', backref='property', lazy=True)
